...
// ▎Задача 4: Прототипное наследование
// Создайте цепочку объектов с прототипным наследованием
...
console.log(Cat)
console.log(Animal)
// Добавьте методы в прототип и проверьте их доступность в наследниках
// Переопределите метод в наследнике и продемонстрируйте затенение
